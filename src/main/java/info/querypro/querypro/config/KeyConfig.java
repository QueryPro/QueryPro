...
import info.querypro.querypro.dto.KeyResponseDto;
import info.querypro.querypro.exeption.KeyMangerException;
...
public class KeyConfig {
    ...
    public String keyStore(String keyId) {
        try {
            ...
            InputStream result = new ClassPathResource("queryPro.p12").getInputStream();
